...
import com.example.ejbasmtest.MoneyTransferTest.service.FundTransferService;
...
public class FundTransferController {
    ...
    @PostMapping
    public ResponseEntity sendFundTransfer(@RequestBody FundTransferRequestDto fundTransferRequest) {
